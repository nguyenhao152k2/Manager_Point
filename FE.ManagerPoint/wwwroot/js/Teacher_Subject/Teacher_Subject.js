        ...
        "columns": [
            ...
            },
            {
                "data": null, "orderable": false, render: function (row) {
                    let edit = `<a class="link-warning" onclick="GetById(${row.Id})" style="cursor: pointer; text-decoration: none"><i class="fa-solid fa-wrench mx-2"></i>Cập nhật</a>`; //margin - right: 20px;
                    let remove = `<a class="link-danger" onclick="deleteSubject(${row.Id})" style="cursor: pointer; text-decoration: none;"><i class="fa-solid fa-trash mx-2"></i>Xoá</a>`;
