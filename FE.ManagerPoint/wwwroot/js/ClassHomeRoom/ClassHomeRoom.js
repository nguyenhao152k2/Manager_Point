function GetClassOnBoard(classInfo) {
    if (classInfo && classInfo.length > 0) {
        ...
        classInfo.forEach(item => {
            var statusBadge = item.status === "Đang chủ nhiệm" ?
                '<span class="badge rounded-pill bg-success">Đang chủ nhiệm</span>' :
                '<span class="badge rounded-pill bg-danger">Đã chủ nhiệm</span>';
        ...
        document.getElementById("classInfo10Div").innerHTML = "<h5>Không có thông tin lớp học.</h5>";
        document.getElementById("classInfo11Div").innerHTML = "<h5>Không có thông tin lớp học.</h5>";
        document.getElementById("classInfo12Div").innerHTML = "<h5>Không có thông tin lớp học.</h5>";
    }
}
