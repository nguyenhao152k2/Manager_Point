        ...
        "columns": [
            ...
            },
            {
                "data": null, "orderable": false, render: function (row) {
                    let edit = `<a class="link-warning" onclick="GetById(${row.Id})" style="cursor: pointer; margin-right: 20px; text-decoration: none"><i class="fa-solid fa-wrench mx-2"></i> Sửa Quyền</a>`;
                    let remove = `<a class="link-danger" style="cursor: pointer; text-decoration: none;"><i class="fa-solid fa-trash mx-2"></i> Xoá Quyền</a>`;
    ...
    this.$table = $('#teacher_role_table').DataTable({
        ...
        "columns": [
            ...
            },
            {
                "data": null, "orderable": false, render: function (row) {
                    let edit = `<a class="link-warning" onclick="GetById(${row.Id})" style="cursor: pointer; margin-right: 20px; text-decoration: none"><i class="fa-solid fa-wrench mx-2"></i> Sửa Quyền</a>`;
                    let remove = `<a class="link-danger" onclick="deleteRole(${row.Id})" style="cursor: pointer; text-decoration: none;"><i class="fa-solid fa-trash mx-2"></i> Xoá Quyền</a>`;
                    return `<div>${edit} ${remove}</div>`;
                }
            },
        ],
