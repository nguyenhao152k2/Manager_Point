...
namespace API.Controllers
{
    ...
    public class Teacher_ClassesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Remove_Item_By_IdUser_and_IdSubject(int userId, int subjectId, int idClass)
        {
            return Ok(await _teacher_ClassServices.Remove_Item_By_IdUser_and_IdSubject(userId, subjectId, idClass));
        }
        ...
        [HttpDelete("/teacher_class/Batch_Remove_Item_Subject")]
        public async Task<IActionResult> Batch_Remove_Item_Subject(int UserId, int classId)
        {
            return Ok(await _teacher_ClassServices.Batch_Remove_Item_Subject(UserId, classId));
        }
    }
}
