...
namespace API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpGet("/user/Count_Student_In_Year")]
        ...
        [HttpGet("/user/Count_All_Rank_Student_GradeLevel")]
        ...
        public IActionResult Authenticate(AuthenticateRequest model)
        {
            ...
            if (response == null)
                return BadRequest(new { message = "Tài khoản hoặc mật khẩu của bạn không đúng!" });
		...
		public async Task<IActionResult> Changepassword(int id,string password)
		{
			...
			return Ok(await _userServices.ChangePassWord(id, password));
		}
	}
}
