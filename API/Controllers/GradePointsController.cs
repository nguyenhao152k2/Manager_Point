...
namespace API.Controllers
{
    ...
    public class GradePointsController : Controller
    {
		...
		[HttpGet("/gradepoint/GradePointByClass1")]
		public async Task<IActionResult> GradePointByClass1(int idClass, int? semester = null)
		{
			return Ok(await _classService.GradePointByClass1(idClass, semester));
		}
