...
namespace BLL.Services.Interface
{
    public interface ITeacher_ClassServices
    {
        ...
        public Task<bool> Remove_Item_By_IdUser_and_IdSubject(int userId, int subjectId,int idClass);
        public Task<bool> Batch_Remove_Item_HomeRoom(int idClass);
        public Task<bool> Batch_Remove_Item_Subject(int UserId, int classId);
